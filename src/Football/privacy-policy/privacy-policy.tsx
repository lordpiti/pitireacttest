export const privacyPolicy = () => (
  ...
  <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank"
      ...
      Company downloaded by You on any electronic device, named FootballTestApp
    </p>
            </li>
            <li>
                <p>
    ...
    <a
                    href="https://piti-react-test.herokuapp.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                >https://piti-react-test.herokuapp.com/</a
                >
            </li>
        </ul>
    </div>
